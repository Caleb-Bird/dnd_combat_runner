class CombatantsController < ApplicationController
  ...
  private
    ...
    def combatant_params
      params.require(:combatant).permit(:Name, :Initiative, :HP_Max, :HP, :Temp_HP, :AC, :Str_Save, :Dex_Save, :Con_Save, :Wis_save, :Int_save, :Cha_Save, :Death_Save_Pass, :Death_Save_Fail)
    end
end
