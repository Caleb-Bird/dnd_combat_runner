...
class CombatantManager extends Component {
  state = {
  } 
  constructor (props) {
    super(props);
  ...
  render() { 
    return (
      ...
      <table className="table table-hover table-bordered">
        ...
        <tbody>
        {this.props.combatants_in_combat.sort((cic1,cic2)=>(cic2.working_initiative-cic1.working_initiative)).map((combatant_in_combat, index) => (
            <tr key={index}>
